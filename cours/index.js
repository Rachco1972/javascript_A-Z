...
/*Priorités en css <div> > #id > .class > baliseHtml*/
...
//Location
// console.log(location.href);lien exact ou est l'utilisateur
// console.log(location.host);nom du site hoste
// console.log(location.pathname);element apres le host
// console.log(location.search); apres ? recherche utilisateur sur php
// location.replace("http://lequipe.fr");reirigé vers un autre lien ou site
